                    ...
                    <tr>
                        ...
                        <td class='row g-2 align-items-center' >
                           ...
                           <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                            <a href="{{ route('board.admins.show' , $user) }}" class="btn btn-primary w-100 btn-icon" aria-label="Facebook">
                        ...
                        @can('update admins')
                        <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                            <a href="{{ route('board.admins.edit' , $user ) }}" class="btn btn-warning w-100 btn-icon" aria-label="Facebook">
