			...
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.areas.store') }}' enctype="multipart/form-data" >
					...
					<div class="card-header bg-primary">
						<h3 class="card-title text-white"> Add New Area </h3>
					</div>
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<div>
								<label class="form-check">
									...
									<span class="form-check-label"> Show In website </span>
								</label>
							</div>
						</div>
					</div>
					<div class="card-footer text-end">
						<div class='d-flex' >
							<a href="{{ route('board.users.index') }}" class="btn btn-link"> Back </a>
